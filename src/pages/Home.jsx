  ...
  <div className="space-y-2 text-gray-800" style={{ fontFamily: 'Arial, sans-serif' }}>
    ...
    <div className="bg-blue-50 border-l-3 border-blue-600 p-2 rounded">
      <p className="text-[11px] leading-snug">
        ...
        অনুমোদিত ব্যাংক, প্রতিষ্ঠান ও এই পোর্টাল ব্যতীত অন্য কারো হতে টিকেট ক্রয় করলে ঐ টিকেটের জন্য বাংলাদেশ থ্যালাসামিয়া সমিতি ও সংশ্লিষ্ট কর্তৃপক্ষ দায়ী থাকবে না।
      </p>
    </div>
    ...
    <div className="bg-yellow-50 border-l-3 border-yellow-600 p-2 rounded">
      <p className="text-[11px] leading-snug">
        ...
        লটারীর ড্র এর নির্ধারিত তারিখ ২৩ জানুয়ারী ২০২৬; বিজয়ীদের তালিকা সংবাদপত্রের মাধ্যমে প্রকাশ করা হবে। সেই সাথে বর্তমান ওয়েবসাইটেও (bdlotteryticket.com) বিজয়ীদের তালিকা প্রকাশ হবে।
      </p>
    </div>
    ...
    <div className="bg-red-50 border-l-3 border-red-600 p-2 rounded">
      <p className="text-[11px] leading-snug">
        ...
        ফলাফল প্রকাশের ৩০ দিনের মধ্যে বিজয়ীদের পুরষ্কারের জন্য নাম ঠিকানা, সত্যায়িত ছবি ও টিকিট প্রাপ্তির এসএমএস সহ লিখিত দাবী কর্তৃপক্ষের নিকট দাখিল করতে হবে। অনলাইন টিকেটের ক্ষেত্রে টিকেটহোল্ডারকে হেল্পলাইনে (09606541934) অথবা support@wintelbd.com এ যোগাযোগ করার জন্য অনুরোধ জানানো হচ্ছে।
      </p>
    </div>
